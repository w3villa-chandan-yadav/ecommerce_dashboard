...
const data2=[
  ...
  const datas = [[400,800,1200,500,300,700,400,700,300,350,550],
  [70,30,52,60,60,20,80,35,35,150,50],
  [243,250,100,260,320,370,200,340,240,420,150],
  [40,80,60,70,20,20,40,20,10,50,50]]
...
const [indexs,setIndexs] =useState(datas[0])

 function getDatasetAtEvent(){
     const newArray = datas.filter((_,id)=>{
      return id ===months
     })
 ...
 useEffect(() => {
      ...
      <div className='text-gray-700 merriweather-bold '>
        ...
        <div className='w-full  grid grid-cols-4 custom-margin  gap-[10px] '>
          ...
          <div key={index} className='bg-whitee w-full h-[130px] rounded-2xl custom-padding'>
            ...
            <h3 className='merriweather-bold font-[500] text-gray-700'>{item.heading}</h3><span className='relative group hover:bg-gray-300 rounded-full h-[20px] cursor-pointer w-[20px] grid place-items-center'><IoMdMore /> 
             <div className=' absolute bg-gray-300 right-0 top-[38%] rounded-2xl text-center  w-[140px] flex-col  z-30  hidden group-hover:flex ' style={{padding:"15px 8px"}}>
              {
                item.hoverTile.map((ele,index)=>{
                  return <Link className='hover:bg-gray-500 bg-gray-400 rounded-2xl' style={{padding:"10px 5px"}}>{ele}</Link>
                })
              }
            ...
            <div className='flex justify-between items-center'>
              <div className='flex items-center gap-2 merriweather-bold  font-[400] text-xs text-gray-800 '>
        ...
        <div className='w-full  grid grid-cols-3  gap-[10px]'>
         ...
         <div className='flex justify-between items-center ' style={{margin:"3px 0px"}}>
          ...
          <div className='flex gap-3'>
            {
              ["12 Months","30 Days","7 Days","24 Hours"].map((item,index)=>{
                return(
                  ...
                  className={`button-paddingg ${index===months && "bg-orange-500 "} merriweather-bold font-medium text-xs cursor-pointer  rounded-md`}>{item}</button>
                )
              })
            }
          </div>
           ...
           <div className='w-full flex justify-center h-[230px] '>
          ...
          
            {
                ...
                data:[300,670,800,460,260,640,340,650,200,300,500],
                borderRadius:5,
          ...
          <div className='bg-whitee w-full  merriweather-regular text-sm font-semibold rounded-3xl custom-padding'>
            <div className='flex justify-between items-center ' style={{marginBottom:"20px"}}>           
              ...
              <div className='flex justify-start items-center gap-1'>
                    ...
                    <div>
                      <h3 className='font-medium text-gray-700'>Tiddo App  </h3>
                      <h4 className=' text-xs font-light text-gray-700'>19 Members</h4>
                   </div>

                  </div>
                   <div>
                     <MdNavigateNext className='text-2xl text-gray-400 font-light'/> 
                   </div>
              ...
              <div className='flex justify-start items-center gap-1 '>
                    ...
                    <div>
                      <h3 className='font-medium text-gray-700'>Homies SASS Aplicaiton  </h3>
                      <h4 className=' text-xs font-light text-gray-700'>24 Members</h4>
                   </div>
              ...
              <div className='flex justify-start items-center gap-1'>
                    ...
                    <div>
                      ...
                      <h4 className=' text-xs font-light text-gray-700'>22 Projects</h4>
                   </div>
              ...
              <div className='flex justify-start items-center gap-1 '>
                    ...
                    <div>
                      <h3 className='font-medium text-sm text-gray-700'>Completed  </h3>
                      <h4 className=' text-xs font-light text-gray-700'>10 Projects</h4>
                   </div>
          ...
          <div className='w-full bg-white  merriweather-regular text-sm font-semibold rounded-3xl custom-padding'>
  ...
  data={{
    datasets: [{
      label: "Data",
      data: [70, 30],  // First slice has 70, second slice has 30
      borderRadius: 10,
      cutout: '65%',
      ...
      backgroundColor: (context) => {
        ...
        if (index === 0) {
          const gradient = ctx.createLinearGradient(0, 0, 0, chart.height);
          gradient.addColorStop(0, 'purple');  // Start color of gradient
          gradient.addColorStop(1, 'blue');     // End color of gradient
          return gradient;
        }
    ...
    {
      label: "Data",
      data: [80, 20],  // First slice has 70, second slice has 30
      borderRadius: 10,
      cutout: '58%',
          ...
          <div className='bg-whitee w-full  merriweather-regular text-sm font-semibold rounded-3xl custom-padding'>
            <div className='flex justify-between items-center ' style={{marginBottom:"20px"}}>           
               <h3 className='text-gray-700'>Daily Tasks</h3>
                <button style={{padding:"5px 16px"}} className='bg-gray-400 rounded-3xl text-gray-300'> Today</button>
            </div>
            {
                data2.map((item,index)=>{
                  return(
          <div key={index} className='bg-whitee w-full h-[130px] rounded-2xl  border-[2px] border-gray-300' style={{padding:"15px 7px",margin:"10px 0px"}}>
            <div className='flex justify-between items-center'>
